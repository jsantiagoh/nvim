...
let s:sol_base03    = { "gui": "#002b36", "cterm": "234" }
let s:sol_base02    = { "gui": "#073642", "cterm": "235" }
let s:sol_base01    = { "gui": "#586e75", "cterm": "240" }
let s:sol_base00    = { "gui": "#657b83", "cterm": "241" }
let s:sol_base0     = { "gui": "#839496", "cterm": "244" }
let s:sol_base1     = { "gui": "#93a1a1", "cterm": "245" }
let s:sol_base2     = { "gui": "#eee8d5", "cterm": "254" }
let s:sol_base3     = { "gui": "#fdf6e3", "cterm": "230" }
let s:sol_yellow    = { "gui": "#b58900", "cterm": "136" }
let s:sol_orange    = { "gui": "#cb4b16", "cterm": "166" }
let s:sol_red       = { "gui": "#dc322f", "cterm": "160" }
let s:sol_magenta   = { "gui": "#d33682", "cterm": "125" }
let s:sol_violet    = { "gui": "#6c71c4", "cterm": "61"  }
let s:sol_blue      = { "gui": "#268bd2", "cterm": "33"  }
let s:sol_cyan      = { "gui": "#2aa198", "cterm": "37"  }
let s:sol_green     = { "gui": "#859900", "cterm": "64"  }

let s:black           = s:sol_base03
let s:medium_gray     = s:sol_base00
let s:white           = s:sol_base3
let s:actual_white    = { "gui": "#FFFFFF", "cterm": "231" }
let s:light_black     = s:sol_base02
let s:lighter_black   = s:sol_base01
let s:subtle_black    = { "gui": "#303030", "cterm": "236" }
let s:light_gray      = s:sol_base0
let s:lighter_gray    = s:sol_base1
let s:lightest_gray   = s:sol_base2
let s:pink            = { "gui": "#FB007A", "cterm": "9"   }
let s:dark_red        = { "gui": "#C30771", "cterm": "1"   }
let s:light_red       = { "gui": "#E32791", "cterm": "1"   }
let s:orange          = s:sol_orange
let s:darker_blue     = { "gui": "#005F87", "cterm": "18"  }
let s:dark_blue       = { "gui": "#008EC4", "cterm": "4"   }
let s:blue            = s:sol_blue
let s:light_blue      = { "gui": "#B6D6FD", "cterm": "153" }
let s:dark_cyan       = s:sol_cyan
let s:light_cyan      = { "gui": "#4FB8CC", "cterm": "14"  }
let s:dark_green      = s:sol_green
let s:light_green     = { "gui": "#5FD7A7", "cterm": "10"  }
let s:dark_purple     = { "gui": "#523C79", "cterm": "5"   }
let s:light_purple    = { "gui": "#6855DE", "cterm": "13"  }
let s:light_yellow    = s:sol_yellow
let s:dark_yellow     = s:sol_orange
...
if &background == "dark"
  ...
  let s:comment         = s:light_gray
  let s:selection       = s:lightest_gray
  let s:warning         = s:red
endif
...
call s:h("Pmenu",         {"fg": s:light_black, "bg": s:lightest_gray})
